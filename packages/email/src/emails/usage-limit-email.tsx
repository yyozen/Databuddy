	...
	return (
		...
		>
			...
			<Section className="mt-4">
				...
				>
					{isLimitReached
						? `You've used all ${limitAmount} of your included ${featureName.toLowerCase()} for this billing period.`
						: `You've exhausted your ${featureName.toLowerCase()} allowance for this period.`}
				</Text>
			</Section>
			...
			<Section>
				<Text
					...
					style={{ color: "#717175" }}
				>
					To continue tracking events without interruption, consider upgrading
