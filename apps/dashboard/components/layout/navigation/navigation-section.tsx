	...
	return (
		<>
			<button
				className={clsx(
					className,
					"flex h-10 items-center gap-3 border-b px-3 text-left font-medium text-sidebar-foreground text-sm focus:outline-none",
					isExpanded
						? "border-b bg-sidebar-accent-brighter"
