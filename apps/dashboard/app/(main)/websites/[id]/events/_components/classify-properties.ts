...
export function classifyEventProperties(
    ...
    const distributionsByEventProp = groupDistributionsByEventAndProperty(distributions);
    ...
    return events.map((event) => {
        ...
        for (const classification of eventClassifications) {
            ...
            if (classification.render_strategy === 'distribution_bar' ||
        ...
        detailProperties.sort((a, b) =>
            b.classification.cardinality - a.classification.cardinality
        );
...
export function getPropertyTypeLabel(classification: PropertyClassification): string {
    switch (classification.inferred_type) {
        ...
        case 'aggregatable': return 'Top Values';
        case 'text': return 'Text';
        case 'high_cardinality': return 'Unique';
